    ...
    return (
        <>
            ...
            <div className='mobileHero'>
                <video src="/hero.mp4" loop autoPlay muted className='heroImageMobile' />
                <h1 className='mobileHeroContent' style={{ fontSize: '1.6rem', color: 'black' }}>Go beyond <Typewriter
                    options={{
                        strings: ['Barrio Logan', 'Chula Vista', 'East Village', 'Hillcrest', 'Little Italy', 'North Park', 'Old Town', 'Pacific Beach', 'Point Loma', 'Scripps Ranch', 'City Heights', 'Tierrasanta', 'Kearney Mesa', 'Clairemont'],
                        autoStart: true,
                        loop: true,
                        wrapperClassName: 'heroContentTypewriterMobile',
                        cursorClassName: 'heroContentTypewriterCursor'
                    }}
